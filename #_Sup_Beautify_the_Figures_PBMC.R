...
##### UMAP sample tsne #####
p1_2 <- DimPlot(PBMC.combined, reduction = "tsne", group.by = "sample")
p1_2 + 
  # scale_colour_gradient2(low = "black", mid = "#3528c7", high = "#ff85e9", 
  #                        guide = "colourbar",midpoint = 0, labs(fill ="Exp")) +
  #            ggtitle(Main)+
...
##### UMAP Cluster #####
p2 <- DimPlot(PBMC.combined, label = TRUE, repel = TRUE,label.size = 4,ncol = 3)
p2 + 
  # scale_colour_gradient2(low = "black", mid = "#3528c7", high = "#ff85e9", 
  #                        guide = "colourbar",midpoint = 0, labs(fill ="Exp")) +
  #            ggtitle(Main)+
...
##### UMAP sample #####
p3 <- DimPlot(PBMC.combined, label = TRUE, reduction = "umap", ncol = 2,split.by = "sample",label.size = 4)
p3 + 
  # scale_colour_gradient2(low = "black", mid = "#3528c7", high = "#ff85e9", 
  #                        guide = "colourbar",midpoint = 0, labs(fill ="Exp")) +
  #            ggtitle(Main)+
...
##### UMAP Cachexia #####
p4 <- DimPlot(PBMC.combined, label = TRUE, reduction = "umap", ncol = 2,split.by = "Cachexia",label.size = 5)
p4 + 
  # scale_colour_gradient2(low = "black", mid = "#3528c7", high = "#ff85e9", 
  #                        guide = "colourbar",midpoint = 0, labs(fill ="Exp")) +
  #            ggtitle(Main)+
...
##### UMAP Sex #####
p5 <- DimPlot(PBMC.combined, label = TRUE, reduction = "umap", ncol = 2,split.by = "Sex",label.size = 5)
p5 + 
  # scale_colour_gradient2(low = "black", mid = "#3528c7", high = "#ff85e9", 
  #                        guide = "colourbar",midpoint = 0, labs(fill ="Exp")) +
  #            ggtitle(Main)+
...
p6 <- DimPlot(PBMC.combined, label = TRUE ,group.by = "seurat_clusters", label.size = 5)
p6 + 
  # scale_colour_gradient2(low = "black", mid = "#3528c7", high = "#ff85e9", 
  #                        guide = "colourbar",midpoint = 0, labs(fill ="Exp")) +
  #            ggtitle(Main)+
...
##### UMAP CellType #####
p7 <- DimPlot(PBMC.combined, label = TRUE, reduction = "umap",group.by = "celltype", label.size = 5)
p7 + 
  # scale_colour_gradient2(low = "black", mid = "#3528c7", high = "#ff85e9", 
  #                        guide = "colourbar",midpoint = 0, labs(fill ="Exp")) +
  #            ggtitle(Main)+
...
##### Bubble TypeID #####
Bubble1 <- DotPlot(PBMC.combined, features = markers.to.plot, cols = c("#1f2041","#4b3f72","#119da4", "#19647e"), dot.scale = 8, split.by = "TypeID") +
  RotatedAxis()
...
##### Bubble Cachexia #####
Bubble2 <- DotPlot(PBMC.combined, features = markers.to.plot, cols = c("#cb1b16","#003f88"), dot.scale = 8, split.by = "Cachexia") +
    RotatedAxis()
...
##### Bubble Sex #####
Bubble3 <- DotPlot(PBMC.combined, features = markers.to.plot, cols = c( "#5b8e7d","#7b2cbf"), dot.scale = 8, split.by = "Sex") +
  RotatedAxis()
...
Bubble4 <- DotPlot(PBMC.combined, features = Cachexia_Marker_HM, cols = c("#e864a4", "#c90c5e","#4169e1","#092e9c"), dot.scale = 8, split.by = "TypeID") +
  RotatedAxis()
Bubble4+ 
  theme(axis.text.x = element_text(face="bold",  size=10),
        axis.text.y = element_text(face="bold",size=10),
