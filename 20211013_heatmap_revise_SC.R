...
raw.df <- read.csv(
  ...
  "D:/Ch_Bioinformatics Dropbox/Chang Charlene/##_GitHub/0-R/##_PHH_Lab/2021_Cachexia/20211121_SC/SC_Cachexia.Marker_Sum_LogFC_M.txt",
  sep = "\t"
)

Sig.df <- read.csv(
  # "D:/KLC/### Datasets/Cachexia_differential-gene-heatmap/20210923/20210921_SC/Cachexia_SC_GSEAforCheck.txt",
  "D:/Ch_Bioinformatics Dropbox/Chang Charlene/##_GitHub/0-R/##_PHH_Lab/2021_Cachexia/20211121_SC/Cachexia_SC_GSEAforCheck.txt",
...
write.table(
  ...
  file = paste0(getwd(),"/output/SC_PairedMarker.tsv"),
  sep = "\t",
  quote = F,
  row.names = F
)
