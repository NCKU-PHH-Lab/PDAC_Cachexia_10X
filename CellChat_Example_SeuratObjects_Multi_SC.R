...
#   ProjectName = "SC_Main_CellChat" # Secret, ECM, CC
...
##### Load CellChat object of each dataset and then merge together #####
  ...
  CellChatOne(SC_EO.combined,
              ...
              save.path = paste0(Save.Path,"/CellCell_Interaction"),
...
## Merge cellchat ##
  cellchat.EO <- readRDS("D:/Dropbox/##_GitHub/##_PHH_Lab/PDAC_Cachexia_10X/2022-09-07_SC_Main/B04_CellCell_InteractionCC_EO_CellChat_Example_PRJCA001063.rds")
  cellchat.LO <- readRDS("D:/Dropbox/##_GitHub/##_PHH_Lab/PDAC_Cachexia_10X/2022-09-07_SC_Main/B04_CellCell_InteractionCC_LO_CellChat_Example_PRJCA001063.rds")
