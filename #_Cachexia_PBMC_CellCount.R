...
##### Load RData  ##### 
  load("D:/Dropbox/##_GitHub/##_PHH_Lab/2021_Cachexia/20220210V1_PBMC/06_Cell_type_annotation.RData")
  
##### S01 Count Cell number  #####
...
##### Other method #####
  ...
  # Freq_sample.df <- fn(Pheno.df$sample)
  # Freq_CT.df <- fn(Pheno.df$celltype)
