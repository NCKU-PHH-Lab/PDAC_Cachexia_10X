...
if(SampleType == "PBMC"){
  ...
  rm(list=setdiff(ls(), c("cellchat_SC_CC","cellchat_SC_ECM","cellchat_SC_Secret",
                          "netVisual_heatmap_Ch")))
...
##### Heatmap #####
#### Ori ####
ComHeatmapT1 <- netVisual_heatmap(cellchat_PBMC_CC)
ComHeatmapT1

ComHeatmapT2 <- netVisual_heatmap(cellchat_PBMC_CC, measure = "weight",
                                 #color.heatmap = c("#2166ac", "#b2182b"),
)
ComHeatmapT2

#> Do heatmap based on a merged object
ComHeatmapT1 + ComHeatmapT2
...
ProjectName = paste0(SampleType,"_CellChat_Beautify_Plot") # Secret, ECM, CC
